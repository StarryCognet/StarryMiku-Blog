...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "593933246", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "StarryMiku", // 主页横幅主标题

			subtitle: [
				"我们都有自己的一片星空,未必璀璨,只要抬头,它便在那里",
				"今でもあなたは私の光",
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/593933246",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "/assets/home/default-logo.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "StarryCognet",
	bio: "我们都有自己的一片星空,未必璀璨,只要抬头,它便在那里",
	typewriter: {
	...
	links: [
		...
		},
		{
			name: "Gitee",
			icon: "mdi:git",
			url: "https://gitee.com/starrycognet",
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/starrycognet",
		},
		{
			name: "Discord",
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://deluxe-gecko-7dcf15.netlify.app/.netlify/functions/twikoo",
		lang: SITE_LANG,
	},
	giscus: {
...
export const announcementConfig: AnnouncementConfig = {
	title: "✨ 欢迎来到 StarryMiku", // 公告标题，填空使用i18n字符串Key.announcement
	content: "点击查看本站完整公告", // 公告内容
